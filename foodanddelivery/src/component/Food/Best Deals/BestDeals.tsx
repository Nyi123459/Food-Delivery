      ...
      <div className="flex flex-col ml-[10%] mr-[10%] gap-y-20">
        <div className="flex border rounded-lg shadow-lg shadow-gray-400">
          <div className="w-2/5 ml-[2%] mt-[5%] max-lgl:mt-[4%] mr-[2%] flex flex-col gap-y-3">
            <h1 className="text-3xl font-extrabold mdx:text-2xl xs:text-base max-w-15">
              {" "}
              Best deals{" "}
              <span className="text-shadownav">Crispy Sandwiches</span>
            </h1>
            <p className="text-gray-600 mdx:text-sm xs:text-xs max-h-10">
              Enjoy the large size of sandwiches. Complete perfect slice of
              sandwiches.
            </p>
            <button
              className="border border-none flex items-center mt-[17%] max-lgl:mt-[10%] h-[15%] w-auto justify-center bg-gradient-to-r from-btcolor1 to-btcolor2 rounded-md hover:-translate-y-1 hover:scale-110 transition duration-700 ease-in-out"
              style={{
                boxShadow:
