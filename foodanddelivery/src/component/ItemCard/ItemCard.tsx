...
const ItemCard: React.FC<ProductProps> = (props) => {
  ...
  // const rootId = props.title.toLowerCase().split(" ").join("");
  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-white rounded-lg shadow-md shadow-amber-100 overflow-hidden group border-slate-400">
