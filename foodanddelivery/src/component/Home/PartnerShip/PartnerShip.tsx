...
// const PartnerShip = () => {
//   return (
//     <section className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-20 pt-6 py-20 md:py-24">
//       <div className="flex flex-wrap justify-center gap-8">
//         {partnerShips.map((data, index) => (
//           <div
//             className="flex flex-col items-center max-w-sm md:max-w-xs lg:max-w-sm"
//             key={index}
//           >
//             <img
//               src={data.icon}
