...
function BeOurPartner() {
  ...
  return (
    <>
      <div
        className="hover:-translate-y-1 hover:scale-110 hover:bg-yellow-500 border-[1.2px] transition duration-700 ease-in-out rounded-lg border-white shadow shadow-primary px-[20px] py-[5px] "
